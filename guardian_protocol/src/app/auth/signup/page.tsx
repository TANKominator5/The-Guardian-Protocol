    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="bg-slate-800 border border-slate-700 shadow-2xl">
          <CardHeader className="text-center space-y-2">
            ...
            <CardDescription className="text-slate-400">
              Set up your Guardian Protocol account
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <form onSubmit={handleSignUp} className="space-y-4">
              ...
              {/* Terms & Conditions */}
              <div className="space-y-2">
                <label className="flex items-start gap-3 text-sm text-slate-400 cursor-pointer hover:text-slate-300">
                  <input
                    type="checkbox"
        ...
        <div className="mt-6 text-center text-xs text-slate-500">
          <p>Campus Security System • Entry Resolution & Security Monitoring</p>
        </div>
      </div>
    </div>
  );
